        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              <h3>UI DESIGN</h3>
              <h4>Crafting Beautiful Interfaces</h4>
              <p>
                Designing intuitive, pixel-perfect, and visually appealing interfaces that captivate users and align with brand identity.
              </p>
              ...
              <div className="what-content-flex">
                ...
                <div className="what-tags">Visual Hierarchy</div>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Conducting user research, usability testing, and developing functional design systems to solve real-world user problems.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
